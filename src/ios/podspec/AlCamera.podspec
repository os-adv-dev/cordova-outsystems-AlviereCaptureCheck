Pod::Spec.new do |s|
  ...
  s.source            = {
    :http => "https://github.com/Alviere/alviere-camera-ios/releases/download/#{s.version}/AlCamera.zip",
    :sha256 => '12a08352817265923ee23f3bb982fc79e934b5e170bd6bba65e8b14899595e08'
  }
