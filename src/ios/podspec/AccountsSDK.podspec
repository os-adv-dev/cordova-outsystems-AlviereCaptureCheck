Pod::Spec.new do |s|
  ...
  s.source            = {
    :http => "https://github.com/Alviere/alviere-accounts-ios/releases/download/#{s.version}/AccountsSDK.xcframework.zip",
    :sha256 => '1ec5603bcaf2fb4d153c2089d48933abc92475cf5373a87ece3e3e08cccb4140'
  }
